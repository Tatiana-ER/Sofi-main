...
<body>
    <div class="print-controls no-print">
        ...
        <a href="generar_pdf_factura_venta.php?id=<?= $id ?>" class="print-btn btn-pdf" target="_blank">
            <span>📄</span> Descargar PDF
        </a>
        <a href="generar_excel_factura_venta.php?id=<?= $id ?>" class="print-btn btn-excel" target="_blank">
