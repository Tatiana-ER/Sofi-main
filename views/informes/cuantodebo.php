...
<body>
  ...
  <section id="services" class="services">
    ...
    <div class="container" data-aos="fade-up">
      ...
      <form id="formPdf" action="../../exports/pdf/generar_pdf_proveedores.php" method="POST" target="_blank" style="display: none;">
          <input type="hidden" id="datosProveedoresPdf" name="datosProveedores">
          <input type="hidden" id="fechaPdf" name="fecha">
      </form>

      <form id="formExcel" action="../../exports/excel/exportar_cuanto_debo_excel.php" method="POST" target="_blank" style="display: none;">
