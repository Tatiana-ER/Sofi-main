  ...
  <section id="services" class="services">
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row g-3 mt-2">
        ...
        <form id="formPdf" action="../../exports/pdf/generar_pdf.php" method="POST" target="_blank" style="display: none;">
            <input type="hidden" id="datosClientesPdf" name="datosClientes">
            <input type="hidden" id="fechaPdf" name="fecha">
        </form>

        <form id="formExcel" action="../../exports/excel/generar_excel_clientes.php" method="POST" target="_blank" style="display: none;">
