...
<body class="p-4">
  ...
  <form id="formPdf" action="../../exports/pdf/movimientoinventarios_pdf.php" method="POST" target="_blank" style="display: none;">
...
<br>
  ...
  <form id="formExcel" action="../../exports/excel/movimientoinventarios_excel.php" method="POST" style="display: none;">
