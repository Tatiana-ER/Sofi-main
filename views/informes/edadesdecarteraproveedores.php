  ...
  <header id="header" class="fixed-top d-flex align-items-center ">
   ...
   <section id="services" class="services">
    ...
    <div class="container" data-aos="fade-up">
      ...
      <form id="formPdf" action="../../exports/pdf/exportar_edades_proveedores_pdf.php" method="POST" target="_blank" style="display: none;">
          <input type="hidden" id="datosPdf" name="datos">
      </form>

      <form id="formExcel" action="../../exports/excel/exportar_edades_proveedores_excel.php" method="POST" target="_blank" style="display: none;">
