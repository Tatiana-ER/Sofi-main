      ...
      <div class="row">
        <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
          <div class="icon-box">
            ...
            <h4><a href="cuantomedeben.php">CUANTO ME DEBEN</a></h4>
            <p>El reporte Cuánto me deben muestra el total y detalle de las cuentas por cobrar, incluyendo documentos pendientes, fechas de vencimiento y antigüedad de la deuda. Permite controlar la cartera y planificar la liquidez y el flujo de caja.</p>
          </div>
        </div>
