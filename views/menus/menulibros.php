        ...
        <div class="row">
          <div class="col-md-6 d-flex align-items-stretch mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="../libros/librosestadodesituacionfinanciera.php">Estado de situación financiera</a></h4>
          ...
          <div class="col-md-6 d-flex align-items-stretch mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4><a href="../libros/librosestadoderesultados.php">Estado de resultados</a></h4>
          ...
          <div class="col-md-6 d-flex align-items-stretch mb-4" data-aos="fade-up" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4><a href="../libros/librosbalancedeprueba.php">Balance de prueba</a></h4>
          ...
          <div class="col-md-6 d-flex align-items-stretch mb-4" data-aos="fade-up" data-aos-delay="400">
            <div class="icon-box">
              ...
              <h4><a href="../libros/libroslibroauxiliar.php">Libro auxiliar</a></h4>
          ...
          <div class="col-md-6 d-flex align-items-stretch mb-4" data-aos="fade-up" data-aos-delay="500">
            <div class="icon-box">
              ...
              <h4><a href="../libros/libroslibrodeventas.php">Libro de ventas</a></h4>
          ...
          <div class="col-md-6 d-flex align-items-stretch mb-4" data-aos="fade-up" data-aos-delay="600">
            <div class="icon-box">
              <i class="bi bi-briefcase"></i>
              <h4><a href="../libros/libroslibrodecompras.php">Libro de compras</a></h4>
          ...
          <div class="col-md-6 d-flex align-items-stretch mb-4" data-aos="fade-up" data-aos-delay="700">
            <div class="icon-box">
              ...
              <h4><a href="../libros/librosmovimientodecaja.php">Movimiento de caja</a></h4>
