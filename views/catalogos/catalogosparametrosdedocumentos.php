...
<body>
  ...
  <section id="services" class="services">
    <button class="btn-ir" onclick="window.location.href='../menus/menucatalogos.php'">
    ...
    <div class="row">
      <div class="col-md-6 d-flex align-items-stretch mb-4" data-aos="fade-up" data-aos-delay="100">
        <div class="icon-box">
          ...
          <h4><a href="../../ajax/parametrosfacturadeventa.php">FACTURA DE VENTA</a></h4>
      ...
      <div class="col-md-6 d-flex align-items-stretch mb-4" data-aos="fade-up" data-aos-delay="200">
        <div class="icon-box">
          ...
          <h4><a href="../../ajax/parametrosfacturadecompra.php">FACTURA DE COMPRA</a></h4>
      ...
      <div class="col-md-6 d-flex align-items-stretch mb-4" data-aos="fade-up" data-aos-delay="300">
        <div class="icon-box">
          <i class="bi bi-clipboard2-check"></i>
          <h4><a href="../../ajax/parametrosrecibodecaja.php">RECIBO DE CAJA</a></h4>
      ...
      <div class="col-md-6 d-flex align-items-stretch mb-4" data-aos="fade-up" data-aos-delay="400">
        <div class="icon-box">
          <i class="bi bi-cash-stack"></i>
          <h4><a href="../../ajax/parametroscomprobantedeegreso.php">COMPROBANTE DE EGRESO</a></h4>
      ...
      <div class="col-md-6 d-flex align-items-stretch mb-4" data-aos="fade-up" data-aos-delay="400">
        <div class="icon-box">
          <i class="bi bi-cash-stack"></i>
          <h4><a href="../../ajax/parametroscomprobantecontable.php">COMPROBANTE CONTABLE</a></h4>
