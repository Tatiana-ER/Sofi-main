...
<body>
    <div class="print-controls no-print">
        ...
        <a href="../../exports/pdf/generar_pdf_comprobante_egreso.php?id=<?= $id ?>" class="print-btn btn-pdf" target="_blank">
            <span>📄</span> Descargar PDF
        </a>
        <a href="../../exports/excel/generar_excel_comprobante_egreso.php?id=<?= $id ?>" class="print-btn btn-excel" target="_blank">
    ...
    <div class="container">
        ...
        <div class="totals">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td class="total-row final" style="text-align: right;">TOTAL PAGADO:</td>
