...
<body>
    <div class="print-controls no-print">
        ...
        <a href="../../exports/pdf/generar_pdf_factura_venta.php?id=<?= $id ?>" class="print-btn btn-pdf" target="_blank">
            <span>📄</span> Descargar PDF
        </a>
        <a href="../../exports/excel/generar_excel_factura_venta.php?id=<?= $id ?>" class="print-btn btn-excel" target="_blank">
                ...
                <td width="33%">
                    ...
                    <div class="section-content">
                        ...
                        <?php if ($factura['retenciones'] > 0): ?>
                            <div style="margin-top: 8px;">Retención: <?= htmlspecialchars($factura['retencion_tarifa'] ?? '0') ?>%</div>
                        <?php endif; ?>
                    </div>
                </td>
