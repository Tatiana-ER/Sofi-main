...
<body>
    <div class="print-controls no-print">
        ...
        <a href="../../exports/pdf/generar_pdf_comprobante_contable.php?id=<?= $id ?>" class="print-btn btn-pdf" target="_blank">
            <span>📄</span> Descargar PDF
        </a>
        <a href="../../exports/excel/generar_excel_comprobante_contable.php?id=<?= $id ?>" class="print-btn btn-excel" target="_blank">
