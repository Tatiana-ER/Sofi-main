...
header('Content-Disposition: attachment; filename="Recibo_Caja_' . $recibo['consecutivo'] . '_' . date('Y-m-d') . '.xls"');
...
<head>
    ...
    <style>
        ...
        .receipt-title { font-size: 20px; font-weight: bold; color: #2c3e50; margin-bottom: 10px; }
        .receipt-number { font-size: 16px; color: #2c3e50; }
        ...
        .message { margin: 20px 0; padding: 15px; background-color: #d1f2eb; border-left: 4px solid #2c3e50; font-style: italic; color: #0a3622; }
...
<body>
    <div class="container">
        <!-- Encabezado -->
        <table width="100%" border="0" cellpadding="0" cellspacing="1" style="margin-bottom: 30px; padding-bottom: 15px; border-bottom: 2px solid #2c3e50;">
            <tr>
        ...
        <table width="300" border="0" cellpadding="0" cellspacing="0" style="margin-left: auto; margin-top: 20px;">
            <tr style="font-weight: bold; font-size: 14px; background-color: #f8f9fa;">
                <td style="padding: 12px 0; border-bottom: 2px solid #2c3e50; text-align: right;">TOTAL RECIBIDO:</td>
