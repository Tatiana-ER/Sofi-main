  ...
  <header id="header" class="fixed-top d-flex align-items-center ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li>
            <a class="nav-link scrollto active" href="dashboard.html" style="color: darkblue;">Inicio</a>
          </li>
          <li>
            <a class="nav-link scrollto active" href="perfil.html" style="color: darkblue;">Mi Negocio</a>
          </li>
          <li>
    ...
    <section id="services" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <br><br><br><br><br>
          <h2>DASHBOARD</h2>
          <p>Aquí encuentras las diferentes opciones configuradas para su cuenta de usuario.</p>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="menucatalogos.html">CATÁLOGOS</a></h4>
          ...
          <div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4><a href="menudocumentos.html">DOCUMENTOS</a></h4>
          ...
          <div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4><a href="menuinformes.html">INFORMES</a></h4>
          ...
          <div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="400">
            <div class="icon-box">
              ...
              <h4><a href="menulibros.html">LIBROS</a></h4>
