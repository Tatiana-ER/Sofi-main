...
<body>
    <div class="print-controls no-print">
        ...
        <a href="generar_pdf_comprobante_egreso.php?id=<?= $id ?>" class="print-btn btn-pdf" target="_blank">
            <span>📄</span> Descargar PDF
        </a>
        <a href="generar_excel_comprobante_egreso.php?id=<?= $id ?>" class="print-btn btn-excel" target="_blank">
