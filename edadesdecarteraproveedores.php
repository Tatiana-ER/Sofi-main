    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="mb-3">
        <form action="" method="post">
          <label for="campo" class="form-label">Identificación proveedor</label>
      ...
      <div class="mb-3">
        <form action="" method="post">
          <label for="campo" class="form-label">Nombre proveedor</label>
          <input type="text" class="form-control" name="campo" id="campo">
        </form>
      </div>
      ...
      <div class="mb-3">
        <form action="" method="post">
          <label for="campo" class="form-label">Edades de cartera</label>
          <input type="text" class="form-control" name="campo" id="campo">
        </form>
      </div>
      ...
      <script>
        function addRow() {
            ...
            cell2.innerHTML = '<input type="text" name="nombre_proveedor">';
            cell3.innerHTML = '<input type="text" name="documento">';
            cell4.innerHTML = '<input type="text" name="fecha_de_vencimiento">';
            cell5.innerHTML = '<input type="text" name="saldo_sin_vencer">';
            cell6.innerHTML = '<input type="text" name="vencido_1-30_dias">';
            cell7.innerHTML = '<input type="text" name="vencido_31-60_dias">';
            cell8.innerHTML = '<input type="text" name="vencido_mayor_60dias">';
        }
      </script>
