...
header('Content-Disposition: attachment; filename="libro_ventas_' . date('Ymd_His') . '.xls"');
...
<body>
    <div class="header-info">
        <h2 style="text-align: center; margin-bottom: 20px;">LIBRO DE VENTAS</h2>
        ...
        <?php if ($cliente_identificacion != ''): ?>
            <p style="text-align: center;"><strong>Cliente:</strong> <?= htmlspecialchars($cliente_identificacion) ?></p>
        <?php endif; ?>
    ...
    <table>
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr><td colspan="8" style="text-align:center; color:#6c757d; font-style:italic;">No hay facturas de venta en el período seleccionado.</td></tr>
            <?php endif; ?>
        </tbody>
    </table>
</body>
